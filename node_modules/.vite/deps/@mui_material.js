...
var AvatarGroup = React27.forwardRef(function AvatarGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime33.jsxs)(AvatarGroupRoot, _extends({
    ...
    children: [extraAvatars ? (0, import_jsx_runtime32.jsx)(AvatarGroupAvatar, _extends({
      ownerState,
      variant
...
function CssBaseline(inProps) {
  ...
  return (0, import_jsx_runtime61.jsxs)(React50.Fragment, {
...
var DialogContext = React51.createContext({});
if (true) {
...
var FormControlLabel = React61.forwardRef(function FormControlLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime72.jsxs)(FormControlLabelRoot, _extends({
    ...
    children: [React61.cloneElement(control, controlProps), required ? (0, import_jsx_runtime72.jsxs)(Stack_default, {
      display: "block",
...
var GridContext = React63.createContext();
if (true) {
...
var Grid = React64.forwardRef(function Grid2(inProps, ref) {
  const themeProps = useThemeProps2({
    props: inProps,
    name: "MuiGrid"
  });
...
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match, setMatch] = React65.useState(() => {
    if (noSsr && matchMedia) {
...
var maybeReactUseSyncExternalStore = React65["useSyncExternalStore"];
function useMediaQueryNew(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const getDefaultSnapshot = React65.useCallback(() => defaultMatches, [defaultMatches]);
  const getServerSnapshot = React65.useMemo(() => {
    if (noSsr && matchMedia) {
      return () => matchMedia(query).matches;
    }
  ...
  const [getSnapshot, subscribe] = React65.useMemo(() => {
    if (matchMedia === null) {
      return [getDefaultSnapshot, () => () => {
      }];
    }
...
var Tooltip = React111.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const closeTimer = React111.useRef();
  const enterTimer = React111.useRef();
  const leaveTimer = React111.useRef();
  const touchTimer = React111.useRef();
  ...
  const stopTouchInteraction = React111.useCallback(() => {
...
var TablePaginationActions = React141.forwardRef(function TablePaginationActions2(props, ref) {
  ...
  return (0, import_jsx_runtime165.jsxs)("div", _extends({
    ...
    children: [showFirstButton && (0, import_jsx_runtime164.jsx)(FirstButtonSlot, _extends({
      ...
      children: theme.direction === "rtl" ? (0, import_jsx_runtime164.jsx)(LastButtonIcon, _extends({}, slotProps.lastButtonIcon)) : (0, import_jsx_runtime164.jsx)(FirstButtonIcon, _extends({}, slotProps.firstButtonIcon))
      ...
      children: theme.direction === "rtl" ? (0, import_jsx_runtime164.jsx)(NextButtonIcon, _extends({}, slotProps.nextButtonIcon)) : (0, import_jsx_runtime164.jsx)(PreviousButtonIcon, _extends({}, slotProps.previousButtonIcon))
      ...
      children: theme.direction === "rtl" ? (0, import_jsx_runtime164.jsx)(PreviousButtonIcon, _extends({}, slotProps.previousButtonIcon)) : (0, import_jsx_runtime164.jsx)(NextButtonIcon, _extends({}, slotProps.nextButtonIcon))
      ...
      children: theme.direction === "rtl" ? (0, import_jsx_runtime164.jsx)(FirstButtonIcon, _extends({}, slotProps.firstButtonIcon)) : (0, import_jsx_runtime164.jsx)(LastButtonIcon, _extends({}, slotProps.lastButtonIcon))
    }))]
  }));
});
...
function useScrollTrigger(options = {}) {
  ...
  const store = React153.useRef();
  const [trigger, setTrigger] = React153.useState(() => getTrigger(store, other));
  React153.useEffect(() => {
    const handleScroll = () => {
